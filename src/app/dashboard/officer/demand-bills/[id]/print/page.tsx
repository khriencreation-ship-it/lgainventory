    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] gap-4 p-6 bg-white">
        ...
        <div className="text-center">
          ...
          <p className="text-xs text-slate-450 mt-1 max-w-sm">{error || 'Demand bill data could not be retrieved.'}</p>
        </div>
        <Link
  ...
  return (
    <div className="min-h-screen bg-slate-100/35 p-0 sm:py-8 flex flex-col items-center relative">
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        @media screen {
          aside, header:not(.bill-doc-header), #officer-sidebar, #officer-header {
        ...
        @media print {
          aside, header, #officer-sidebar, #officer-header, .no-print {
            display: none !important;
          }
          .md\\:ml-64 {
            margin-left: 0 !important;
      ...
      <div className="no-print w-full max-w-[210mm] bg-white border border-slate-200 rounded-2xl p-4 mb-6 shadow-sm flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          <span className="text-xs text-slate-450 font-bold uppercase tracking-wider mr-2 bg-slate-50 border border-slate-200 px-2.5 py-1 rounded-lg">
      ...
      <div className="print-container w-full max-w-[210mm] bg-white border border-slate-300/80 rounded-none shadow-lg p-[15mm] flex flex-col justify-between text-slate-800 leading-snug font-sans min-h-[265mm] relative overflow-hidden">
        ...
        <div className="space-y-6 z-10 relative">
          ...
          <div className="grid grid-cols-3 border border-slate-350 rounded-lg overflow-hidden text-[10px]">
            <div className="p-2 border-r border-slate-350 bg-slate-50/70">
              <span className="text-[8px] font-black text-slate-450 uppercase tracking-wider block">Demand Notice Ref</span>
            ...
            <div className="p-2 border-r border-slate-350">
              <span className="text-[8px] font-black text-slate-450 uppercase tracking-wider block">Date of Assessment</span>
            ...
            <div className="p-2 bg-red-50/30">
              <span className="text-[8px] font-black text-slate-450 uppercase tracking-wider block">Due Date (Final)</span>
              <strong className="text-red-750 font-black block mt-0.5">
          ...
          <div className="border border-slate-350 rounded-lg overflow-hidden text-[10px]">
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-slate-50 border-b border-slate-350 text-[8.5px] font-black text-slate-450 uppercase tracking-wider">
          ...
          <div className="p-2.5 bg-slate-50 border border-slate-250 rounded-lg text-[10px] leading-normal">
            <span className="text-[8px] font-black text-slate-400 uppercase block tracking-wider">Total Amount in Words</span>
        ...
        <div className="space-y-4 pt-4 z-10 relative">
          ...
          <div className="p-2 border border-slate-200 bg-slate-50/50 rounded-lg text-[8.5px] text-slate-500 leading-snug text-center italic">
          ...
          <div className="border-t border-dashed border-slate-400 pt-3 flex flex-col gap-1.5 relative">
            ...
            <div className="grid grid-cols-4 gap-4 text-[10px] font-semibold leading-tight pt-0.5">
                ...
                {bill.amount_paid > 0 ? (
                  <div className="space-y-0.5">
                    ...
                    <div className="text-[9px] text-slate-700 font-medium">
                      ...
                      <div className="border-t border-slate-200 mt-0.5 pt-0.5">Balance: <span className="font-black text-indigo-700">{formatNaira(bill.balance_due)}</span></div>
                    </div>
                  </div>
                ) : (
                  <div>
              ...
              <div className="text-right">
                ...
                <span className="text-red-750 font-black block mt-0.5 font-mono">
                  {new Date(bill.due_date).toLocaleDateString('en-GB')}
                </span>
              </div>
            </div>
