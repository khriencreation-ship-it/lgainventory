  ...
  if (error || !bill) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] gap-3">
        ...
        <Link
          href="/dashboard/treasurer/demand-bills"
          ...
          <div className="relative">
            ...
            {billDropdownOpen && (
              <div className="absolute left-0 mt-1.5 w-44 bg-white border border-slate-200 shadow-lg rounded-xl z-20 py-1.5">
                <Link
                  href={`/dashboard/treasurer/demand-bills/${bill.id}/print?copy=customer`}
                  target="_blank"
                ...
                <Link
                  href={`/dashboard/treasurer/demand-bills/${bill.id}/print?copy=lg`}
                  target="_blank"
                  onClick={() => setBillDropdownOpen(false)}
                  className="block px-4 py-2 text-xs font-bold text-slate-700 hover:bg-slate-50 hover:text-slate-900 transition-colors"
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2">
              <div className="space-y-4">
                <div>
                  ...
                  <Link
                    href={`/dashboard/treasurer/clients/${bill.client_id}`}
