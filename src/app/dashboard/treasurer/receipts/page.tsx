                  ...
                  return (
                    <tr key={row.id} className="hover:bg-slate-50/40 transition-colors">
                      ...
                      <td className="py-3.5 px-5 font-extrabold text-slate-900 hover:text-indigo-650 transition-colors">
                        <Link href={`/dashboard/treasurer/demand-bills/${row.demand_bill_id}`}>
                          {row.demand_bill_reference}
                        </Link>
                      </td>
                      <td className="py-3.5 px-5 font-extrabold text-slate-900 hover:text-indigo-650 transition-colors">
                        <Link href={`/dashboard/treasurer/clients/${row.client_id}`}>
                          {row.client_name}
                        </Link>
                      </td>
                      ...
                      <td className="py-3.5 px-5 text-center">
                        <Link
                          href={`/dashboard/treasurer/receipts/${row.id}`}
