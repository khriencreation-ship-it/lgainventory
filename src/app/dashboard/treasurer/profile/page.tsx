  ...
  return (
    <div className="space-y-6 max-w-3xl mx-auto">
      ...
      <div>
        ...
        <p className="text-xs text-slate-450 font-medium mt-0.5">Manage your treasurer details, official signature, and password settings.</p>
      </div>
      ...
      <div className="flex items-start gap-3 p-4 bg-indigo-50 border border-indigo-100 rounded-2xl">
        ...
        <div>
          <p className="text-xs font-bold text-indigo-800">Treasurer Account — Restricted Access</p>
          <p className="text-[10px] text-indigo-600 mt-0.5 leading-relaxed">
            As the Council Treasurer, your account is read-only for most fields. You may update your phone number, official signature, and password.
          </p>
        </div>
      </div>
        ...
        <div className="bg-white rounded-3xl border border-slate-200/60 shadow-sm overflow-hidden">
          ...
          <div className="p-6 space-y-5">
            ...
            <p className="text-[10px] text-slate-400 leading-relaxed">
              Your signature will appear on all printed demand bills and receipts as Council Treasurer. Upload a clear, high-quality image of your handwritten signature on a plain white background.
            </p>
          </div>
        </div>
