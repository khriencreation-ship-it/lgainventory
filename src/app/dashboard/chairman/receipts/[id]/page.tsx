  ...
  if (error || !receipt) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] gap-3">
        ...
        <Link
          href="/dashboard/chairman/receipts"
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        <div className="flex flex-wrap items-center gap-2 shrink-0">
          <Link
            href={`/dashboard/chairman/demand-bills/${receipt.demand_bill_id}/print?copy=customer`}
            target="_blank"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2">
              <div className="space-y-4">
                <div>
                  ...
                  <Link
                    href={`/dashboard/chairman/clients/${receipt.client_id}`}
                ...
                <div>
                  ...
                  <Link
                    href={`/dashboard/chairman/demand-bills/${receipt.demand_bill_id}`}
