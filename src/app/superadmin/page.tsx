  ...
  return (
    <div className="w-full max-w-md px-4 sm:px-6">
      ...
      <div className="flex flex-col mb-8 md:hidden">
        ...
        <h1 className="text-2xl font-black text-slate-900">Khrien</h1>
        <p className="text-sm text-slate-500 mt-1">Super Admin Operations Portal</p>
      </div>
      ...
      <div className="bg-white rounded-3xl p-8 transition-all duration-300">
        <div className="mb-6 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400 mt-0.5 font-medium">Platform operations sign in.</p>
          </div>
        </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="superadmin@khrien.com"
    ...
    <div className="min-h-screen bg-slate-50 text-slate-800 flex flex-col md:flex-row relative overflow-hidden">
      ...
      <div className="hidden md:flex md:w-1/2 lg:w-3/5 bg-slate-950 relative overflow-hidden flex-col justify-between p-12">
        <div className="absolute inset-0 z-0">
          <Image
            src="/entrepreneur-conducting-data-sales-research-with-invoices-other-expenses.jpg"
            alt="Operations Landscape"
            fill
        ...
        <div className="z-20 flex items-center gap-3">
          <div>
            <span className="font-extrabold text-white text-base tracking-tight block">LGA Revenue Management System</span>
            <span className="text-[10px] text-orange-400 font-bold uppercase tracking-wider block">Super Admin Dashboard</span>
          </div>
        </div>
        ...
        <div className="z-20 max-w-lg space-y-4">
          <h2 className="text-3xl lg:text-4xl font-extrabold text-white leading-tight tracking-tight shadow-sm">
            Manage multi-state local government tenants.
          </h2>
          <p className="text-sm text-slate-300 leading-relaxed font-medium">
            Provision and audit states, onboard municipal administrations, manage local government user credentials, and track consolidated nationwide revenue logs.
          </p>
        </div>
